                                                        ...
                                                        child: BorderButton(
                                                          ...
                                                          onTap: (){
                                                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>
                                                                OrderDetailsScreen(order: ordersList![index],
                                                                    fromAccepted: homeProvider.acceptedList.contains(ordersList![index].id)? true: false)));
                                                          },
                                                        ),
                                                      ...
                                                      if(homeProvider.finishedList.contains(ordersList![index].id))
                                                        ...
                                                        Padding(padding: EdgeInsets.all(6),
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text('Expired', style: TextStyle(color: Colors.red, fontStyle: FontStyle.italic)),
                                                          ) :
                                                          Container(
                                                            height: 40.0,
                                                            child: BorderButton(
